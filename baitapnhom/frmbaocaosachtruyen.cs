...
namespace baitapnhom
{
    public partial class frmbaocaosachtruyen : Form
    {
        ...
        {
            DAO.connect();
            string sql = "select masach,tensach,maloaisach from sachtruyen   where exists (select masach from chitietthuesach where chitietthuesach.masach = sachtruyen.masach) and not exists(select masach from chitiettrasach where chitiettrasach.masach = sachtruyen.masach)"; 
